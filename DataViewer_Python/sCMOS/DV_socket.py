...
class DataViewerSocket:
    def __init__(self, dest_addr, dest_port = 10030):
        ...
        self.cmd_dict = {'Exposure': 'd', 'NImages': 'i32', 'CaptureMode': 'i32', 'NFrames': 'i32', 'Resolution': 'i32', 'Mode': 'i32', 'Interframe': 'd', 'Trigger': 'i32', 'FrameWaiting': 'i32', 'q2c_SetFileName' : 's', 'actionCapture' : 'i32', 'actionAbort': 'i32', 'InputTriggerEdge' : 'i32', 'OutputEdge': 'i32', 'OutputTrigger' : 'i32', 'Gain' : 'd', 'Trigger' : 'i32'};
