...
class MaskExtractor:
    def __init__(self):
        ...
        self.valid_values = [];
        for capIdx in range(self.num_caps):
    ...
    def extract_frame(self, curr_frame, cap_num = 0):
        ...
        curr_valid = self.valid_values[cap_num]; # Presently a NOP
        self.valid_values[cap_num].extend(valid_pixels.reshape((1,-1)).tolist()[0]);
        return;
